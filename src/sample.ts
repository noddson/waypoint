...
export function irelandSample(): Trip { const now=new Date().toISOString(); return { id:uid(), name:'Ireland summer escape', destination:'Ireland', createdAt:now, updatedAt:now, items:[
  ...
  i('car','Collect rental car','2026-07-20T16:00',undefined,'Europe/Dublin',{provider:'Budget via Expedia',location:'Dublin',notes:'Rental pickup; sanitized confirmation'}),
  ...
  i('car','Return rental car','2026-07-31T16:00',undefined,'Europe/Dublin',{provider:'Budget via Expedia',location:'Dublin',notes:'Rental return; sanitized confirmation'}),
